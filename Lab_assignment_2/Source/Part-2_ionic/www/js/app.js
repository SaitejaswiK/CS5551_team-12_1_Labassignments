...
exampleApp.controller('ExampleController', function($scope, $http) {
    ...
    $scope.getData = function() {
        $http.get("http://api.walmartlabs.com/v1/items?apiKey=2ak4gmgxsab3xfed6vp9xdvs&upc="+upc+"&format=json")
         ...
         $http.get("http://api.walmartlabs.com/v1/reviews/"+id+"?apiKey=2ak4gmgxsab3xfed6vp9xdvs&format=json")
            .success(function(data) {
